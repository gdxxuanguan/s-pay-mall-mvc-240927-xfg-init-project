...
/**
 * 微信服务对接，对接地址：<a href="http://yanami.natapp1.cc/api/v1/weixin/portal/receive">/api/v1/weixin/portal/receive</a>
 * <p>
 * http://yanami.natapp1.cc/api/v1/weixin/portal/receive/
 */
@Slf4j
@RestController()
@CrossOrigin("*")
    ...
    public String post(@RequestBody String requestBody,
        ...
        try {
            ...
            if(message.getMsgType().equals("event")&&message.getEvent().equals("SCAN")){
                loginService.saveLoginSate(message.getTicket(),openid);
